/*!
 * NOTE: This file has been modified to use SPI2 on the STM NUCLEO F401RE
 *       Instances of SPI have been changed to SPI_2. SPI_2 has been instantiated here.
 *  

 * @file     RA8875_SPI2.cpp
 *
 * @mainpage Adafruit RA8875 TFT Driver
 *
 * @author   Denny Smith adapted from Limor Friend/Ladyada, K.Townsend/KTOWN for Adafruit Industries
 *
...
static inline void spi_end(void) { SPI_2.endTransaction(); }
#else
...
*/
/**************************************************************************/
RA8875_SPI2::RA8875_SPI2(uint8_t CS, uint8_t RST) : Adafruit_GFX(800, 480) {
  _cs = CS;
  _rst = RST;
}
...
*/
/**************************************************************************/
bool RA8875_SPI2::begin(enum RA8875sizes s) {
  _size = s;
  ...
  SPI_2.setMOSI(PB15);	// DWS Use SPI2 leaving SPI1 free for the SD Card
  SPI_2.setMISO(PB14);
  SPI_2.setSCLK(PB13);
...
#else
  /// @endcond
  spi_speed = 4000000L;   //125000;   // Set to 4 Mhz for Nucleo 64
/// @cond DISABLE
#endif
/// @endcond
#else
...
*/
/**************************************************************************/
void RA8875_SPI2::softReset(void) {
...
*/
/**************************************************************************/
void RA8875_SPI2::initialize(void) {
  PLLinit();
...
*/
/**************************************************************************/
uint16_t RA8875_SPI2::width(void) { return _width; }
...
*/
/**************************************************************************/
uint16_t RA8875_SPI2::height(void) { return _height; }
 ...
 */
/**************************************************************************/
int8_t RA8875_SPI2::getRotation(void) { return _rotation; }
 ...
 */
/**************************************************************************/
void RA8875_SPI2::setRotation(int8_t rotation) {
  switch (rotation) {
  case 2:
    _rotation = rotation;
    break;
...
*/
/**************************************************************************/
void RA8875_SPI2::textMode(void) {
  /* Set text mode */
...
*/
/**************************************************************************/
void RA8875_SPI2::textSetCursor(uint16_t x, uint16_t y) {
  x = applyRotationX(x);
  y = applyRotationY(y);
...
*/
/**************************************************************************/
void RA8875_SPI2::textColor(uint16_t foreColor, uint16_t bgColor) {
  /* Set Fore Color */
  writeCommand(0x63);
...
*/
/**************************************************************************/
void RA8875_SPI2::textTransparent(uint16_t foreColor) {
  /* Set Fore Color */
  writeCommand(0x63);
  writeData((foreColor & 0xf800) >> 11);
  writeCommand(0x64);
...
*/
/**************************************************************************/
void RA8875_SPI2::textEnlarge(uint8_t scale) {
  if (scale > 3)
...
void RA8875_SPI2::cursorBlink(uint8_t rate) {
...
*/
/**************************************************************************/
void RA8875_SPI2::textWrite(const char *buffer, uint16_t len) {
  if (len == 0)
    len = strlen(buffer);
...
*/
/**************************************************************************/
void RA8875_SPI2::graphicsMode(void) {
  writeCommand(RA8875_MWCR0);
  uint8_t temp = readData();
...
*/
/**************************************************************************/
bool RA8875_SPI2::waitPoll(uint8_t regname, uint8_t waitflag) {
...
*/
/**************************************************************************/
void RA8875_SPI2::setXY(uint16_t x, uint16_t y) {
...
*/
/**************************************************************************/
void RA8875_SPI2::pushPixels(uint32_t num, uint16_t p) {
  digitalWrite(_cs, LOW);
  SPI_2.transfer(RA8875_DATAWRITE);
  while (num--) {
    SPI_2.transfer(p >> 8);
    SPI_2.transfer(p);
  }
...
*/
/**************************************************************************/
void RA8875_SPI2::fillRect(void) {
 ...
 */
/**************************************************************************/
int16_t RA8875_SPI2::applyRotationX(int16_t x) {
  switch (_rotation) {
  case 2:
    x = _width - 1 - x;
    break;
 ...
 */
/**************************************************************************/
int16_t RA8875_SPI2::applyRotationY(int16_t y) {
  switch (_rotation) {
  case 2:
    y = _height - 1 - y;
    break;
...
*/
/**************************************************************************/
void RA8875_SPI2::drawPixel(int16_t x, int16_t y, uint16_t color) {
  x = applyRotationX(x);
  y = applyRotationY(y);
  ...
  spi_begin();
  SPI_2.transfer(RA8875_DATAWRITE);
  SPI_2.transfer(color >> 8);
  SPI_2.transfer(color);
  spi_end();
  digitalWrite(_cs, HIGH);
}
 ...
 */
/**************************************************************************/
void RA8875_SPI2::drawPixels(uint16_t *p, uint32_t num, int16_t x,
                                 int16_t y) {
  x = applyRotationX(x);
  y = applyRotationY(y);
...
*/
/**************************************************************************/
void RA8875_SPI2::drawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
                               uint16_t color) {
...
*/
/**************************************************************************/
void RA8875_SPI2::drawFastVLine(int16_t x, int16_t y, int16_t h,
                                    uint16_t color) {
...
*/
/**************************************************************************/
void RA8875_SPI2::drawFastHLine(int16_t x, int16_t y, int16_t w,
                                    uint16_t color) {
...
*/
/**************************************************************************/
void RA8875_SPI2::drawRect(int16_t x, int16_t y, int16_t w, int16_t h,
                               uint16_t color) {
...
*/
/**************************************************************************/
void RA8875_SPI2::fillRect(int16_t x, int16_t y, int16_t w, int16_t h,
                               uint16_t color) {
...
*/
/**************************************************************************/
void RA8875_SPI2::fillScreen(uint16_t color) {
...
*/
/**************************************************************************/
void RA8875_SPI2::drawCircle(int16_t x, int16_t y, int16_t r,
                                 uint16_t color) {
...
*/
/**************************************************************************/
void RA8875_SPI2::fillCircle(int16_t x, int16_t y, int16_t r,
                                 uint16_t color) {
...
*/
/**************************************************************************/
void RA8875_SPI2::drawTriangle(int16_t x0, int16_t y0, int16_t x1,
...
*/
/**************************************************************************/
void RA8875_SPI2::fillTriangle(int16_t x0, int16_t y0, int16_t x1,
                                   int16_t y1, int16_t x2, int16_t y2,
                                   uint16_t color) {
...
*/
/**************************************************************************/
void RA8875_SPI2::drawEllipse(int16_t xCenter, int16_t yCenter,
...
*/
/**************************************************************************/
void RA8875_SPI2::fillEllipse(int16_t xCenter, int16_t yCenter,
                                  int16_t longAxis, int16_t shortAxis,
                                  uint16_t color) {
...
*/
/**************************************************************************/
void RA8875_SPI2::drawCurve(int16_t xCenter, int16_t yCenter,
                                int16_t longAxis, int16_t shortAxis,
...
*/
/**************************************************************************/
void RA8875_SPI2::fillCurve(int16_t xCenter, int16_t yCenter,
                                int16_t longAxis, int16_t shortAxis,
                                uint8_t curvePart, uint16_t color) {
 ...
 */
/**************************************************************************/
void RA8875_SPI2::drawRoundRect(int16_t x, int16_t y, int16_t w, int16_t h,
 ...
 */
/**************************************************************************/
void RA8875_SPI2::fillRoundRect(int16_t x, int16_t y, int16_t w, int16_t h,
                                    int16_t r, uint16_t color) {
...
*/
/**************************************************************************/
void RA8875_SPI2::circleHelper(int16_t x, int16_t y, int16_t r,
...
*/
/**************************************************************************/
void RA8875_SPI2::rectHelper(int16_t x, int16_t y, int16_t w, int16_t h,
                                 uint16_t color, bool filled) {
  x = applyRotationX(x);
  y = applyRotationY(y);
  w = applyRotationX(w);
...
*/
/**************************************************************************/
void RA8875_SPI2::triangleHelper(int16_t x0, int16_t y0, int16_t x1,
                                     int16_t y1, int16_t x2, int16_t y2,
                                     uint16_t color, bool filled) {
  x0 = applyRotationX(x0);
  y0 = applyRotationY(y0);
...
*/
/**************************************************************************/
void RA8875_SPI2::ellipseHelper(int16_t xCenter, int16_t yCenter,
                                    int16_t longAxis, int16_t shortAxis,
                                    uint16_t color, bool filled) {
...
*/
/**************************************************************************/
void RA8875_SPI2::curveHelper(int16_t xCenter, int16_t yCenter,
                                  int16_t longAxis, int16_t shortAxis,
                                  uint8_t curvePart, uint16_t color,
                                  bool filled) {
  xCenter = applyRotationX(xCenter);
 ...
 */
/**************************************************************************/
void RA8875_SPI2::roundRectHelper(int16_t x, int16_t y, int16_t w,
 ...
 */
/**************************************************************************/
void RA8875_SPI2::setScrollWindow(int16_t x, int16_t y, int16_t w,
 ...
 */
/**************************************************************************/
void RA8875_SPI2::scrollX(int16_t dist) {
  writeCommand(0x24);
  writeData(dist);
  writeCommand(0x25);
  writeData(dist >> 8);
 ...
 */
/**************************************************************************/
void RA8875_SPI2::scrollY(int16_t dist) {
  writeCommand(0x26);
  writeData(dist);
  writeCommand(0x27);
  writeData(dist >> 8);
 ...
 */
/**************************************************************************/
void RA8875_SPI2::GPIOX(bool on) {
  if (on)
...
*/
/**************************************************************************/
void RA8875_SPI2::PWM1out(uint8_t p) { writeReg(RA8875_P1DCR, p); }
...
*/
/**************************************************************************/
void RA8875_SPI2::PWM2out(uint8_t p) { writeReg(RA8875_P2DCR, p); }
...
*/
/**************************************************************************/
void RA8875_SPI2::PWM1config(bool on, uint8_t clock) {
  if (on) {
...
*/
/**************************************************************************/
void RA8875_SPI2::PWM2config(bool on, uint8_t clock) {
  if (on) {
...
*/
/**************************************************************************/
void RA8875_SPI2::touchEnable(bool on) {
...
*/
/**************************************************************************/
bool RA8875_SPI2::touchRead(uint16_t *x, uint16_t *y) {
  uint16_t tx, ty;
  uint8_t temp;
...
*/
/**************************************************************************/
void RA8875_SPI2::displayOn(bool on) {
  if (on)
...
*/
/**************************************************************************/
void RA8875_SPI2::sleep(bool sleep) {
  if (sleep)
...
*/
/**************************************************************************/
void RA8875_SPI2::writeReg(uint8_t reg, uint8_t val) {
  writeCommand(reg);
  writeData(val);
}
...
*/
/**************************************************************************/
uint8_t RA8875_SPI2::readReg(uint8_t reg) {
  writeCommand(reg);
  return readData();
}
...
*/
/**************************************************************************/
void RA8875_SPI2::writeData(uint8_t d) {
  digitalWrite(_cs, LOW);
...
*/
/**************************************************************************/
uint8_t RA8875_SPI2::readData(void) {
  digitalWrite(_cs, LOW);

  spi_begin();
  SPI_2.transfer(RA8875_DATAREAD);
  uint8_t x = SPI_2.transfer(0x0);
  spi_end();
 ...
 */
/**************************************************************************/
void RA8875_SPI2::writeCommand(uint8_t d) {
  digitalWrite(_cs, LOW);

  spi_begin();
  SPI_2.transfer(RA8875_CMDWRITE);
  SPI_2.transfer(d);
  spi_end();
 ...
 */
/**************************************************************************/
uint8_t RA8875_SPI2::readStatus(void) {
  digitalWrite(_cs, LOW);
  spi_begin();
  SPI_2.transfer(RA8875_CMDREAD);
  uint8_t x = SPI_2.transfer(0x0);
  spi_end();
...
uint32_t RA8875_SPI2::eepromReadS32(int location) {
 ...
 */
/**************************************************************************/
void RA8875_SPI2::eepromWriteS32(int location, int32_t value) {
 ...
 */
/**************************************************************************/
bool RA8875_SPI2::readCalibration(int location, tsMatrix_t *matrixPtr) {
 ...
 */
/**************************************************************************/
void RA8875_SPI2::writeCalibration(int location, tsMatrix_t *matrixPtr) {
